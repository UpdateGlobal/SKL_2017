...
<div id="wrap">
    ...
    <section class="exito">
        <section>
            ...
            <div class="intro">
                <h1 class="exito1"><strong>Gracias</strong> por contactarnos  <strong>un asesor especializado</strong> Se contactará a la brevedad.</h1>
                <div class="buttons-wrap">
                    
                    <a href="index.html" class="button large">Ver más productos</a>
                </div>
            </div>
