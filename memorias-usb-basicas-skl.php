...
<div id="wrap">
    ...
    <section id="page-title">
    	<div class="container clearfix">
            <h1>SKL &ndash; Memorias USB Básicas</h1>
            <nav id="breadcrumbs">
                <ul>
                ...
                <div class="entry-slider">
                    <div id="flexslider-portfolio-item" class="flex-container">
                        <div class="flexslider">
                            <ul class="slides">
                                <li>
                                	<img src="images/usb/usb-basicas/usb-basico-rojo.jpg" alt=""></a>
                                </li>
                    			<li>
                                	<img src="images/usb/usb-basicas/usb-basico-gris.jpg" alt=""></a>
                                </li>
                    			<li>
                                    <img src="images/usb/usb-basicas/usb-basico-negro-rojo.jpg" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/usb-basicas/usb-basico-verde.jpg" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/usb-basicas/usb-basico-negro.jpg" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
