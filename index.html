...
<div id="wrap">
                ...
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="300">
                        ...
                        <div class="tp-caption small black sft"
                             ...
                             data-start="1500"
                             data-easing="easeOutBack">
                                de Artículos Promocionales para tu empresa
                        </div>
                        ...
                        <div class="tp-caption sfb"
                             ...
                             data-easing="easeOutExpo">
                                <a href="#productos" class="button colored">Más Información</a>
                        </div>
                    </li>
                    ...
                    <!--li data-transition="fade" data-slotamount="7" data-masterspeed="300">
                        ...
                        <div class="tp-caption video sfr"
                             ...
                             data-start="1000"
                             data-easing="easeOutBack">
                                <iframe src="http://player.vimeo.com/video/58413545?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff" width="460" height="259" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
                        </div>
                    </li-->
                </ul>       
           </div>
    ...
    <section>
        <div class="content-featured">
            <div class="container">
                <p>SKL Promocionales Perú, es una empresa peruana especializada en la venta de artículos promocionales de alta calidad con diseños que tu marca necesita, en importación y venta de Memorias USB y Cargadores Portátiles personalizados; gadgets tecnológicos, accesorios para smartphone. Consulta nuestros productos y solicita una cotización.<a href="#productos">Ver Productos &rsaquo;</a></p>
            </div>
        </div>
    </section>
        ...
        <section>
            ...
            <div class="one-fourth">
                <div class="arrowbox arrowbox-first">
                    <h2 class="arrowbox-title">Puntualidad
            ...
            <div class="one-fourth">
                <div class="arrowbox">
                    <h2 class="arrowbox-title">Calidad
            ...
            <div class="one-fourth">
                <div class="arrowbox">
                    <h2 class="arrowbox-title">Garantía
                        <span class="arrowbox-title-arrow-back"></span>
                        <span class="arrowbox-title-arrow-front"></span>
                    </h2>
                </div>
            ...
            <div class="one-fourth column-last">
                <div class="arrowbox">
                    <h2 class="arrowbox-title">Los mejores precios
                        <span class="arrowbox-title-arrow-back"></span>
                        <span class="arrowbox-title-arrow-front"></span>
                    </h2>
                </div>
...
<!-- begin CLIENTES -->
        <section>
            ...
            <ul class="project-carousel project-list">
                <li class="entry">
                    <a><img src="images/clientes/ciemin2017.png" alt=""></a>
                </li>
                <li class="entry">
                    <a><img src="images/clientes/real-plaza.jpg" alt=""></a>
                </li>
                <li class="entry">
                    <a><img src="images/clientes/oit.jpg" alt=""></a>
                </li>
                <li class="entry">
                    <a><img src="images/clientes/colegiomedico.jpg" alt=""></a>
                </li>
                <li class="entry">
                    <a><img src="images/clientes/defontana.jpg" alt=""></a>
                </li>
                <li class="entry">
                    <a><img src="images/clientes/oceano.jpg" alt=""></a>
                </li>
                <li class="entry">
                    <a><img src="images/clientes/tural.jpg" alt=""></a>
                </li>
            </ul>
            </div>
