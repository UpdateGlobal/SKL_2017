...
<script>
  ...
  gtag('config', 'UA-110061247-1');
	...
	<title>SKL USB ECOLÓGICAS</title>
</head>
...
<div id="wrap">
    ...
    <section id="page-title">
    	<div class="container clearfix">
            <h1>SKL &ndash; Memorias USB Ecológicas</h1>
            <nav id="breadcrumbs">
                <ul>
                ...
                <div class="entry-slider">
                    <div id="flexslider-portfolio-item" class="flex-container">
                        <div class="flexslider">
                            <ul class="slides">
                                <li>
                                    <img src="images/usb/ecologicos/memorias-ecologicas-001.jpg" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/ecologicos/memorias-ecologicas-002.jpg" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/ecologicos/memorias-ecologicas-003.jpg" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/ecologicos/memorias-ecologicas-004.jpg" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/ecologicos/memorias-ecologicas-005.jpg" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/ecologicos/memorias-ecologicas-006.jpg" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
