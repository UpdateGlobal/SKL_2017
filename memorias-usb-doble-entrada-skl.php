...
<div id="wrap">
    ...
    <section id="page-title">
    	<div class="container clearfix">
            <h1>SKL &ndash; Memorias USB Doble Entrada</h1>
            <nav id="breadcrumbs">
                <ul>
        ...
        <section>
                ...
                <div class="entry-slider">
                    <div id="flexslider-portfolio-item" class="flex-container">
                        <div class="flexslider">
                            <ul class="slides">
                                <li>
                                	<img src="images/usb/doble-entrada/usb-29-doble-entrada.png" alt=""></a>
                                </li>
                    			<li>
                                	<img src="images/usb/doble-entrada/usb-30-doble-entrada.png" alt=""></a>
                                </li>
                    			<li>
                                    <img src="images/usb/doble-entrada/usb-31-doble-entrada.png" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="one-fourth column-last">
                ...
                <div class="project-description">
                    <h2>Memorias USB de Doble Entrada</h2>
