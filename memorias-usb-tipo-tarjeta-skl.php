...
<script>
  ...
  gtag('config', 'UA-110061247-1');
	...
	<title>SKL USB Tipo Tarjeta</title>
</head>
...
<div id="wrap">
    ...
    <section id="page-title">
    	<div class="container clearfix">
            <h1>SKL &ndash; Memorias USB tipo tarjeta</h1>
            <nav id="breadcrumbs">
                <ul>
        ...
        <section>
                ...
                <div class="entry-slider">
                    <div id="flexslider-portfolio-item" class="flex-container">
                        <div class="flexslider">
                            <ul class="slides">
                                <li>
                                    <img src="images/usb/tarjeta/usb-42-tarjeta.png" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/tarjeta/usb-43-tarjeta.png" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="one-fourth column-last">
                ...
                <div class="project-description">
                    <h2>Memorias USB Tipo Tarjeta</h2>
