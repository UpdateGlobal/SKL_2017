...
<head>
	...
	<title>SKL USB Tipo Llave</title>
</head>
...
<div id="wrap">
    ...
    <section id="page-title">
    	<div class="container clearfix">
            <h1>SKL &ndash; Memorias USB tipo llave</h1>
            <nav id="breadcrumbs">
                <ul>
                ...
                <div class="entry-slider">
                    <div id="flexslider-portfolio-item" class="flex-container">
                        <div class="flexslider">
                            <ul class="slides">
                                <li>
                                    <img src="images/usb/llave/usb-38-llave.png" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/llave/usb-39-llave.png" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/llave/usb-40-llave.png" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/llave/usb-41-llave.png" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
