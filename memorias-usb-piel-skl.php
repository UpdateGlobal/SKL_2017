...
<div id="wrap">
    ...
    <section id="page-title">
    	<div class="container clearfix">
            <h1>SKL &ndash; Memorias USB PIEL</h1>
            <nav id="breadcrumbs">
                <ul>
        ...
        <section>
                ...
                <div class="entry-slider">
                    <div id="flexslider-portfolio-item" class="flex-container">
                        <div class="flexslider">
                            <ul class="slides">
                                <li>
                                	<img src="images/usb/piel/usb-5-piel.png" alt=""></a>
                                </li>
                    			<li>
                                	<img src="images/usb/piel/usb-4-piel.png" alt=""></a>
                                </li>
                    			<li>
                                    <img src="images/usb/piel/usb-6-piel.png" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/piel/usb-7-piel.png" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/piel/usb-8-piel.png" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/piel/usb-9-piel.png" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/piel/usb-10-piel.png" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/piel/usb-11-piel.png" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/piel/usb-12-piel.png" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/piel/usb-13-piel.png" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/piel/usb-14-piel.png" alt=""></a>
                                </li>
                                <li>
                                    <img src="images/usb/piel/usb-15-piel.png" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="one-fourth column-last">
                ...
                <div class="project-description">
                    <h2>Memorias USB de Piel</h2>
                    <p>Memoria USB Básica, que puede personalizarse con el diseño o logotipo de tu elección mediante impresión UV o grabado láser. Fabricada con materiales de la mas alta calidad.<br>Puedes elegir la capacidad de almacenaje entre 512 MB y 16 GB.</p>
                </div>
                <!-- begin project description -->
                
                <!-- begin project details -->
                <div class="project-details">
                    <h2>Detalle Memorias USB Básicas</h2>
