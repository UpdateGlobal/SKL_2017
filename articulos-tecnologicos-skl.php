...
<head>
	...
	<title>SKL Artículos Tecnológicos</title>
</head>
...
<div id="wrap">
    ...
    <header id="header" class="container clearfix">
        ...
        <nav id="nav">
            <ul id="navlist" class="clearfix">
                ...
                <li class="current"><a href="articulos-tecnologicos-skl.html" rel="submenu4">Tecnología</a>
    ...
    <section id="page-title">
    	<div class="container clearfix">
            <h1>SKL Artículos Tecnológicos</h1>
            <nav id="breadcrumbs">
                <ul>
                    <li><a href="index-2.html">Incio</a> &rsaquo;</li>
        ...
        <section>
            ...
            <h2>Elige el Producto que necesitas e indícanos el código</h2>
             <li class="entry one-fourth print-design">
                    <a class="entry-image lightbox" rel="pawer bank" href="images/entries/full-size/sunrise-700x445.png" title="power bank 1"><span class="overlay zoom"></span><img src="images/entries/full-size/sunrise-700x445.png" alt="images/entries/full-size/sunrise-700x445.png"></a>
                    <a class="entry-image lightbox invisible" rel="pawer bank" href="images/lapiceros/lapiceros-plastico-002.jpg" title="power bank 2"><span class="overlay zoom"></span><img src="images/lapiceros/mi-lapiceros-plastico.jpg" alt=""></a>
                   
                <a class="entry-meta" href="contacto_skl.html">
                    <h4 class="entry-title">POWER BANK</h4>
            ...
            <li class="entry one-fourth print-design">
                    <a class="entry-image lightbox" rel="parlantes" href="images/entries/full-size/sunrise-700x445.png" title="parlantes 1"><span class="overlay zoom"></span><img src="images/entries/full-size/sunrise-700x445.png" alt="images/entries/full-size/sunrise-700x445.png"></a>
                    <a class="entry-image lightbox invisible" rel="parlantes" href="images/lapiceros/lapiceros-plastico-002.jpg" title="parlantes 2"><span class="overlay zoom"></span><img src="images/lapiceros/mi-lapiceros-plastico.jpg" alt=""></a>
                   
                <a class="entry-meta" href="contacto_skl.html">
                    <h4 class="entry-title">PARLANTES</h4>
                    <div class="entry-content">
                        <p>Solicítalos Aquí</p>
                    </div>
                        <div class="arrow-box-hover"></div>
             ...
             <li class="entry one-fourth print-design">
                    <a class="entry-image lightbox" rel="bluetooh" href="images/entries/full-size/sunrise-700x445.png" title="bluetooth 1"><span class="overlay zoom"></span><img src="images/entries/full-size/sunrise-700x445.png" alt="images/entries/full-size/sunrise-700x445.png"></a>
                    <a class="entry-image lightbox invisible" rel="bluetooh" href="images/lapiceros/lapiceros-plastico-002.jpg" title="bluetooth 2"><span class="overlay zoom"></span><img src="images/lapiceros/mi-lapiceros-plastico.jpg" alt=""></a>
                   
                <a class="entry-meta" href="contacto_skl.html">
                    <h4 class="entry-title">BLUETOOTH</h4>
                    <div class="entry-content">
                        <p>Solicítalos Aquí</p>
                    </div>
                        <div class="arrow-box-hover"></div>
             ...
             <li class="entry one-fourth print-design">
                    <a class="entry-image lightbox" rel="slefie stick" href="images/entries/full-size/sunrise-700x445.png" title="slefie stick 1"><span class="overlay zoom"></span><img src="images/entries/full-size/sunrise-700x445.png" alt="images/entries/full-size/sunrise-700x445.png"></a>
                    <a class="entry-image lightbox invisible" rel="slefie stick" href="images/lapiceros/lapiceros-plastico-002.jpg" title="slefie stick 2"><span class="overlay zoom"></span><img src="images/lapiceros/mi-lapiceros-plastico.jpg" alt=""></a>
                   
                <a class="entry-meta" href="contacto_skl.html">
                    <h4 class="entry-title">SLEFIE STICK</h4>
                    <div class="entry-content">
                        <p>Solicítalos Aquí</p>
                    </div>
                        <div class="arrow-box-hover"></div>
             ...
             <li class="entry one-fourth print-design">
                    <a class="entry-image lightbox" rel="cargadores" href="images/entries/full-size/sunrise-700x445.png" title="cargadores solares 1"><span class="overlay zoom"></span><img src="images/entries/full-size/sunrise-700x445.png" alt="images/entries/full-size/sunrise-700x445.png"></a>
                    <a class="entry-image lightbox invisible" rel="cargadores" href="images/lapiceros/lapiceros-plastico-002.jpg" title="cargadores solares 2"><span class="overlay zoom"></span><img src="images/lapiceros/mi-lapiceros-plastico.jpg" alt=""></a>
                   
                <a class="entry-meta" href="contacto_skl.html">
                    <h4 class="entry-title">CARGADORES SOLARES</h4>
                    <div class="entry-content">
                        <p>Solicítalos Aquí</p>
                    </div>
                        <div class="arrow-box-hover"></div>
